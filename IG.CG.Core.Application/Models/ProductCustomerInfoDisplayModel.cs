...
{
    public class ProductCustomerInfoDisplayModel
    {
        ...
        public string? ProdInstallationPinCode { get; set; }
        public string? ProdInstallationCityName { get; set; }
        public string? ProdInstallationStateName { get; set; }
