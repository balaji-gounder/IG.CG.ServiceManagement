...
{
    public class AscServiceTicketFirDisplayModel
    {
        ...
        public List<FIRDefectListDisplayModel>? DefectList { get; set; }
        public List<SpareDetailsDisplayModel>? Sparelist { get; set; }
    ...
    public class FIRDefectListDisplayModel
    {
    ...
    public class SpareDetailsDisplayModel
    {
    ...
    public class FIRDocumentListDisplayModel
    {
