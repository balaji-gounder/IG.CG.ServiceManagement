...
{
    public class ASMServiceRequestClaimInfoModel
    {
    ...
    public class ClaimAttachmentListModel
    {
        public string? ServiceTicketNumber { get; set; }
    ...
    public class ASMServiceRequestClaimLineItemsModel
    {
    ...
    public class ASCServiceRequestClaimItemsManageApprovalModel
    {
        public string? ServiceTicketClaimId { get; set; }
        public string? ServiceTicketId { get; set; }
        public string? ServiceTicketNumber { get; set; }
    ...
    public class ASMServiceRequestClaimApprovalModel
    {
    ...
    public class ASCServiceRequestClaimInfoModel
    {
    ...
    public class ASCServiceRequestClaimLineItemsModel
    {
        public string? ServiceTicketClaimId { get; set; }
        public string? ServiceTicketId { get; set; }
    ...
    public class AscClaimApprovalLineItemsModel
    {
        public string? ServiceTicketClaimId { get; set; }
        public string? ServiceTicketId { get; set; }
        public string? TicketNo { get; set; }
    ...
    public class AscServiceRequestClaimReApprovalModel
    {
        public int? ServiceTicketId { get; set; }
        public int? ServiceTicketClaimId { get; set; }
    ...
    public class AscSpecialApprovalClaimModel
    {
        public string? ServiceTicketId { get; set; }
        public decimal ClaimAmount { get; set; }
        public string? Remarks { get; set; }
    ...
    public class IBNPdfInfoModel
    {
        ...
        public List<ClaimDetailsModel>? ClaimDetailsList { get; set; }
    ...
    public class AsmServiceTicketClaimAmountDistanceModel
    {
        public int? ServiceTicketId { get; set; }
        public int? ServiceTicketClaimId { get; set; }
        public decimal ClaimAmount { get; set; }
    ...
    public class AsmIBNTicketClaimAmountModel
    {
        public int? ServiceTicketId { get; set; }
        public int? ServiceTicketClaimId { get; set; }
        public decimal? ClaimAmount { get; set; }
    ...
    public class ASMSpecialApprovalLineItemsModel
    {
    ...
    public class RSMSpecialApprovalLineItemsModel
    {
        public int? SpecialApprovalId { get; set; }
        public int? ServiceTicketId { get; set; }
        public string? ServiceTicketNo { get; set; }
    ...
    public class UpdateRSMSpecialApprovalModel
    {
        public int? SpecialApprovalId { get; set; }
        public int? ServiceTicketId { get; set; }
        public string? ApprovalRemarks { get; set; }
    ...
    public class UpdateASMAcceptRejectionResubmissionModel
    {
    ...
    public class SpecialApprovalClaimAttachmentListModel
    {
        public string? ServiceTicketNumber { get; set; }
        public string? FilePath { get; set; }
    ...
    public class ASCSpecialApprovalLineItemsModel
    {
        public int? SpecialApprovalId { get; set; }
        public int? ServiceTicketId { get; set; }
        public string? ServiceTicketNo { get; set; }
