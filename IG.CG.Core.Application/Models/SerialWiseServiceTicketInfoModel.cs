...
{
    public class SerialWiseServiceTicketInfoModel
    {
        ...
        public List<SpareDetailModel> SpareDetails { get; set; }
    ...
    public class businessCallModel
    {
        public string? serviceTicketId { get; set; }
        public string? businessCallId { get; set; }
    }

    public class ServiceTickeHappyCodeModel
    {
        public string? serviceTicketId { get; set; }
        public string? ServiceTicketNumber { get; set; }
    }

    public class ServiceTickeReplacementTagModel
    {
        public string? ServiceTicketId { get; set; }
